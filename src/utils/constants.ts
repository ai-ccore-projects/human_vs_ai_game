...
import type { AnimationConfig, DifficultyCategory, Controls } from '@/types/game';
...
export const FREE_IMAGE_SOURCES = {
  ...
  ai: {
    ...
    // Faux "AI-looking" Picsum variants for testing
    picsumAI: {
      abstractIds: [100, 102, 104, 106, 108, 110, 112, 114, 116, 118, 200, 202, 204, 206, 208],
      getAbstract: () => {
        const id =
          FREE_IMAGE_SOURCES.ai.picsumAI.abstractIds[
